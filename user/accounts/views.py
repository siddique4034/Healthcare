...
# imported create_event function to create event on Google Calender
...
def home_page(request):
    if (request.user.is_staff == True):
        dr_apt = Appointment.objects.filter(
            doctor_appointed=f"{request.user.first_name} {request.user.last_name}")
